  ...
  return (
    <div className="relative">
      <input
        id={name}
        type={type}
        className={`w-full py-4 px-6 border rounded-xl text-sm font-medium text-text1 placeholder:text-text4 bg-transparent ${
          error.length > 0 ? "border-error" : "border-strock dark:bg-darkStroke"
        } ${children ? "pr-16" : ""}`}
