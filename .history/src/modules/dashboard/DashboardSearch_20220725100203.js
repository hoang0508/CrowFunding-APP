...
const DashboardSearch = () => {
  ...
  return (
    <div className="relative z-50">
      ...
      {showSearch && (
        <div className="absolute top-full left-0 translate-x-5 search-result w-full lg:w-[843px] bg-white z-50 translate-y-5 pb-6 rounded-3xl">
          ...
          <div className="p-6 pb-0">
            ...
            <div className="text-sm font-semibold mb-4">Related searchs</div>
